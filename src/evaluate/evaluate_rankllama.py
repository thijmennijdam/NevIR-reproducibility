...
from evaluate.rerank_rankllama import calc_preferred_rankllama

MODEL_MAP = {
    "rankllama": ("castorini/rankllama-v1-7b-lora-doc", calc_preferred_rankllama, "castorini/rankllama-v1-7b-lora-doc"),
}
