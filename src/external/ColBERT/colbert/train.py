...
# python -m colbert.train --amp --doc_maxlen 180 --mask-punctuation --bsize 32 --accum 1 --triples data/NevIR_data/train_triplets.tsv --root results_finetune/colbert/finetune_nevir --experiment NevIR --similarity l2 --run nevir --lr 3e-06 --checkpoint colbert_weights/ColBERTv1/colbert-v1.dnn