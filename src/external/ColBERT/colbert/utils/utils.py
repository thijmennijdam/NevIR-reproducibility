...
def load_checkpoint(path, model, optimizer=None, do_print=True):
    ...
    if 'model_state_dict' in checkpoint:
        ...
        # Assume the checkpoint itself is the state dictionary
    ...
    if 'epoch' in checkpoint and 'batch' in checkpoint:
        print_message("#> checkpoint['epoch'] =", checkpoint['epoch'])
        print_message("#> checkpoint['batch'] =", checkpoint['batch'])
    else:
        print_message("#> No epoch or batch information found in checkpoint")
