...
from external.pygaggle.model import (BatchTokenizer,
                            LongBatchEncoder,
                            QueryDocumentBatch,
...
class MonoT5(Reranker):
    ...
    def get_prediction_tokens(pretrained_model_name_or_path: str,
        ...
        if not (token_false and token_true):
            ...
            if pretrained_model_name_or_path in prediction_tokens or "checkpoint" in pretrained_model_name_or_path:
                token_false, token_true = prediction_tokens["castorini/monot5-base-msmarco-10k"]
