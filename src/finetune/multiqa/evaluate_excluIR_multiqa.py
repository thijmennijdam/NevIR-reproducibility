...
def predict(args):
    ...
    df = pd.read_csv(args.excluIR_path, sep="\t", header=None, names=["q1", "q2", "doc1", "doc2"])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/home/scur0987/project/IR2/results_finetune/finetune_merged/sentence-transformers_multi-qa-mpnet-base-dot-v1/model",
    ...
    parser.add_argument(
        ...
        "--excluIR_path",
        type=str,
        default="/home/scur0987/project/IR2/data/ExcluIR_data/excluIR_test.tsv",
        help="Path to the ExcluIR dataset",
    )
    parser.add_argument(
        "-lf",
        "--load_finetune",
...
# example usage:
# python evaluate_excluIR.py -o /home/scur0987/project/IR2/results_finetune/finetune_NevIR/sentence-transformers_multi-qa-mpnet-base-dot-v1/model -ptf /home/scur0987/project/IR2/results_finetune/finetune_NevIR/sentence-transformers_multi-qa-mpnet-base-dot-v1/model -lf True -ep /home/scur0987/project/IR2/data/ExcluIR_data/excluIR_test.tsv